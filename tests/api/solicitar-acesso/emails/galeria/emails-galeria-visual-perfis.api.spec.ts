/**
 * Rodar:
 * npx playwright test tests/api/solicitar-acesso/emails-galeria-visual-perfis.api.spec.ts --project=chromium
 */
...
} from "../../../../../tools/functions/api/solicitar-acesso/formulario/criar-solicitacao-publica";
import type { PerfilSolicitacaoAcessoPublica } from "../../../../../tools/functions/api/solicitar-acesso/formulario/criar-solicitacao-publica";
import {
  criarEmailTeste,
...
} from "../../../../../tools/functions/api/solicitar-acesso/consulta/consultar-status";
import { validarSolicitacaoNaFila } from "../../../../../tools/functions/api/solicitar-acesso/solicitacoes/validar-fila-solicitacoes";
import { perfisAutorizadosSolicitacoes } from "../../../../../tools/functions/banco-de-dados/solicitar-acesso/perfis/definir-perfis-teste";
