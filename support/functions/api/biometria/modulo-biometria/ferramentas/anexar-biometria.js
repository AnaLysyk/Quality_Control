...
const { salvarResultadoExecucaoTeste } = require('../codigo-fonte/armazenar-execucao-teste');
...
function mostrarAjuda() {
  ...
  console.log('Uso:');
  console.log('  node ferramentas/anexar-biometria.js --processo-id=88 --arquivo="C:\\\\caminho\\\\digital.wsq" --indice=3 --formato=WSQ');
  console.log('  node ferramentas/anexar-biometria.js --protocolo=220260000088 --arquivo="C:\\\\caminho\\\\digital.png" --indice=3 --formato=PNG');
  console.log('');
...
async function executarAnexo(contextoExecucao) {
  ...
  await salvarResultadoExecucaoTeste({
