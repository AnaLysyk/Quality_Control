/**
 * Rodar:
 * npx playwright test tests/ui/login/solicitar-acesso/acessibilidade/formulario.acessibilidade.ui.spec.ts --project=chromium
 */
import { expect, test } from "@playwright/test";
import { verificarAcessibilidadeDaPagina } from "../../../../../../tools/functions/ui/acessibilidade/verificar-acessibilidade";
import { localizarElementosSolicitarAcesso } from "../../../../../../tools/functions/ui/login/solicitar-acesso/elementos/solicitar-acesso.elementos";
