...
export const NAV_CATALOG: NavModuleDef[] = [
  {
    ...
    items: [
      ...
      { id: "home-dashboard", label: "Dashboard geral", iconKey: "compass", module: "home", href: "/admin/home", allowedRoles: ALL_INTERNAL, favoriteEnabled: true },
    ],
  },
  {
    id: "companies",
    ...
    items: [
      { id: "companies-list",        label: "Listar empresas",       iconKey: "list",         module: "companies", href: "/empresas",               favoriteEnabled: true },
      ...
      { id: "companies-dashboard",   label: "Dashboard da empresa",  iconKey: "compass",      module: "companies", companyRoute: "dashboard",       favoriteEnabled: true },
      { id: "companies-apps",        label: "Aplicações",            iconKey: "grid",         module: "companies", companyRoute: "aplicacoes",      favoriteEnabled: true },
      { id: "companies-plans",       label: "Planos de teste",       iconKey: "book",         module: "companies", companyRoute: "planos-de-teste", favoriteEnabled: true },
      { id: "companies-runs",        label: "Runs",                  iconKey: "play",         module: "companies", companyRoute: "runs",            favoriteEnabled: true },
      { id: "companies-defects",     label: "Defeitos",              iconKey: "alert-circle", module: "companies", companyRoute: "defeitos",        favoriteEnabled: true },
      { id: "companies-integrations",label: "Integrações",           iconKey: "link",         module: "companies", companyRoute: "admin",           favoriteEnabled: true },
      { id: "companies-docs",        label: "Documentos da empresa", iconKey: "file-text",    module: "companies", companyRoute: "documentos",      favoriteEnabled: true },
      { id: "companies-settings",    label: "Configurações",         iconKey: "settings",     module: "companies", companyRoute: "perfil",          allowedRoles: PRIVILEGED, favoriteEnabled: true },
    ],
  },
  {
    id: "operations",
    ...
    allowedRoles: ALL_INTERNAL,
    items: [
      { id: "ops-dashboard",  label: "Dashboard operacional",  iconKey: "compass",   module: "operations", href: "/admin/dashboard",   favoriteEnabled: true },
      { id: "ops-runs",       label: "Runs",                   iconKey: "play",      module: "operations", href: "/admin/runs",        favoriteEnabled: true },
      ...
      { id: "ops-monitoring", label: "Monitoramento",          iconKey: "activity",  module: "operations", href: "/admin/operacao",    favoriteEnabled: true },
      { id: "ops-history",    label: "Histórico operacional",  iconKey: "clock",     module: "operations", href: "/admin/requests",    favoriteEnabled: true },
    ],
  },
  {
    id: "quality",
