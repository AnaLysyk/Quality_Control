/**
 * Rodar:
 * npx playwright test tests/ui/login/solicitar-acesso/perfis/criar-solicitacoes.ui.spec.ts --project=chromium
 */
...
import { capturarChaveDoEmailSolicitacao } from "../../../../../../tools/functions/api/solicitar-acesso/emails/extrair-chave-email";
import { aprovarSolicitacaoPelaTela } from "../../../../../../tools/functions/ui/login/solicitar-acesso/aprovacao/aprovar-solicitacao";
import {
  abrirFormularioSolicitacaoPorPerfil,
  perfisSolicitacao,
  preencherFormularioSolicitacaoPorPerfil,
  prepararMocksPublicosSolicitacao,
} from "../../../../../../tools/functions/ui/login/solicitar-acesso/formulario/preencher-formulario-por-perfil";
