...
import { resolverCaminhoDados } from "./resolver-caminhos-dados";
...
export async function criarExecucoesParaBusca() {
...
export async function criarExecucoesComQualidade() {
  const file = resolverCaminhoDados("releases-manual.json");
  let releases: ManualRelease[] = [];
  try {
...
export async function criarDefeitosForaSla() {
