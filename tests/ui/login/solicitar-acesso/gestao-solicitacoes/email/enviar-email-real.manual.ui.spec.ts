/**
 * Rodar:
 * npx playwright test tests/ui/login/solicitar-acesso/gestao-solicitacoes/email/enviar-email-real.manual.ui.spec.ts --project=chromium
 */
import { expect, test } from "@playwright/test";
import {
  abrirFormularioSolicitacaoPublica,
  selecionarCargoAnalista,
} from "../../../../../../tools/functions/ui/login/solicitar-acesso/formulario/preencher-formulario-publico";
import {
  criarEmailRealUnico,
  perfisEmailRealSolicitacao,
} from "../../../../../../tools/functions/ui/login/solicitar-acesso/compartilhado/preparar-email-real";
