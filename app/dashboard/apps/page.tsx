...
const applications = [
  { slug: "sfq", name: "SFQ", info: "Releases monitoradas com gráficos e detalhamento." },
  ...
  { slug: "cds", name: "CDS", info: "Indicadores e releases priorizados para o CDS." },
  { slug: "gmt", name: "GMT", info: "Histórico compacto das execuções GMT." },
];

export default function DashboardApps() {
  return (
    <div className="min-h-screen bg-[var(--tc-bg)] text-[var(--tc-text-inverse)] px-6 py-10 md:px-10">
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="space-y-1">
          ...
          <p className="text-sm text-[var(--tc-text-secondary)]">Selecione uma aplicação para navegar pelas releases e execuções.</p>
        </div>
