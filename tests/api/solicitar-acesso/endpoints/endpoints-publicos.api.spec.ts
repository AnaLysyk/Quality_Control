/**
 * Rodar:
 * npx playwright test tests/api/solicitar-acesso/endpoints-publicos.api.spec.ts --project=chromium
 */
import { expect, test } from "@playwright/test";
import { endpointsSolicitarAcesso } from "../../../../tools/functions/api/solicitar-acesso/endpoints/solicitar-acesso.endpoints";
