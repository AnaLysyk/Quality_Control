...
export const BIOMETRIC_FIXTURE_DEFINITIONS: BiometricFixtureDefinition[] = [
  ...
  { slug: "medio-direito", label: "MÃ©dio direito", kind: "fingerprint", index: 2, isStandard: true, fileName: "medio direito.png" },
  { slug: "anelar-direito", label: "Anelar direito", kind: "fingerprint", index: 3, isStandard: true, fileName: "Anelar direito.png" },
  { slug: "minimo-direito", label: "MÃ­nimo direito", kind: "fingerprint", index: 4, isStandard: true, fileName: "MÃ­nimo direito.png" },
  ...
  { slug: "medio-esquerdo", label: "MÃ©dio esquerdo", kind: "fingerprint", index: 7, isStandard: true, fileName: "MÃ©dio esquerdo.png" },
  { slug: "anelar-esquerdo", label: "Anelar esquerdo", kind: "fingerprint", index: 8, isStandard: true, fileName: "Anelar esquerdo .png" },
  { slug: "minimo-esquerdo", label: "MÃ­nimo esquerdo", kind: "fingerprint", index: 9, isStandard: true, fileName: "MÃ­nimo esquerdo .png" },
