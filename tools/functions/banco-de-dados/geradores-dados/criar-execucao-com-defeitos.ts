...
export async function criarExecucaoComDefeitos() {
  // Seed para releases-manual.json (run)
  const releasesFile = resolverCaminhoDados("releases-manual.json");
  ...
  const casesFile = resolverCaminhoDados("releases-manual-cases.json");
