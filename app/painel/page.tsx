  ...
  return (
    <div className="min-h-screen bg-[var(--page-bg,#ffffff)] text-[var(--page-text,#0b1a3c)]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-10 space-y-8">
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <p className="text-xs uppercase tracking-[0.4em] text-[var(--tc-accent)]">Runs — Aceitação</p>
            <div className="flex gap-2">
              <button
                type="button"
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <p className="text-xs uppercase tracking-[0.4em] text-[var(--tc-accent)]">Runs — Regressão</p>
            <div className="flex gap-2">
              <button
                type="button"
