...
import {
  ...
  temEmpresaE2E,
} from "../../../tools/functions/ui/usuarios/criar-usuario-por-perfil";
import { BASE_URL, extrairCookie } from "../../../tools/functions/api/autenticacao/autenticar-por-cookie";
import {
  esperarEmailCapturado,
  limparEmailsCapturados,
  type EmailCapturado,
} from "../../../tools/functions/api/solicitar-acesso/emails/capturar-emails";
import { validarMeuPerfilUsuarioCriado } from "../../../tools/functions/ui/usuarios/validar-meu-perfil-usuario-criado";
