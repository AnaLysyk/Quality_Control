...
import type { SystemRouteDefinition } from "@/backend/navigation/navigation.types";
import { PERMISSION_MODULES, type PermissionModule } from "@/backend/permissionCatalog";
