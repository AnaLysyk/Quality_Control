...
import { buildBrainProfileGraphView, getBrainProfileTypes } from "../_utils/brainProfileGraphView";
...
export function BrainNeuralDashboard() {
  ...
  const visibleGraph = useMemo(
    ...
    [activeModule, canSeeAllCompanies, contextCompanies, contextProjects, filteredGraph.edges, filteredGraph.nodes, nodeStatus, nodeType, period, searchText, selectedCompanyId, selectedNode, selectedProfileType, selectedProjectId, showOrphansOnly, showPendingOnly],
  );
