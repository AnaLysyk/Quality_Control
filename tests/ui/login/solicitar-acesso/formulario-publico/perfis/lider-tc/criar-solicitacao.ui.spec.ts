/**
 * Rodar:
 * npx playwright test tests/ui/login/solicitar-acesso/lider-tc/criar-solicitacao.ui.spec.ts --project=chromium
 */
/**
 * Rodar visualmente:
 * npx playwright test tests/ui/login/solicitar-acesso/lider-tc/criar-solicitacao.ui.spec.ts --project=chromium --headed --workers=1
 *
 * Rodar só no terminal:
 * npx playwright test tests/ui/login/solicitar-acesso/lider-tc/criar-solicitacao.ui.spec.ts --project=chromium --workers=1 --reporter=line
 *
