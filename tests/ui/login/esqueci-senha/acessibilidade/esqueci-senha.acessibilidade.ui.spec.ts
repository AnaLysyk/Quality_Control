/**
 * Rodar:
 * npx playwright test tests/ui/login/esqueci-senha/acessibilidade/esqueci-senha.acessibilidade.ui.spec.ts --project=chromium
 */
...
import { localizarElementosEsqueciSenha } from "../../../../../tools/functions/ui/login/esqueci-senha/elementos/esqueci-senha.elementos";
