/**
 * Rodar:
 * npx playwright test tests/ui/login/solicitar-acesso/suporte-tecnico/criar-solicitacao.ui.spec.ts --project=chromium
 */
/**
 * Rodar visualmente:
 * npx playwright test tests/ui/login/solicitar-acesso/suporte-tecnico/criar-solicitacao.ui.spec.ts --project=chromium --headed --workers=1
 *
 * Rodar só no terminal:
 * npx playwright test tests/ui/login/solicitar-acesso/suporte-tecnico/criar-solicitacao.ui.spec.ts --project=chromium --workers=1 --reporter=line
 *
...
} from "../../../../../../../tools/functions/ui/login/solicitar-acesso/solicitacoes/solicitacao-publica";
...
test.describe("UI - Login - Solicitar acesso - Suporte Técnico ", () => {
  ...
  test("deve criar solicitação, validar e-mail recebido e consultar status pendente", async ({ page }) => {
    ...
    const dados: DadosSolicitacaoAcesso = {
      ...
      profileLabel: /Suporte T.cnico/i,
