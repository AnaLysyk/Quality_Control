...
export const notificationPreferenceLayers: NotificationPreferenceLayer[] = [
  ...
  },
  {
    ...
    examples: ["Reset de senha", "Alteracao de permissao", "Bloqueio de acesso", "Release bloqueada"],
  },
];
...
export const notificationWorkflows: NotificationWorkflow[] = [
  ...
  {
    id: "release-calendar-critical",
    eventType: "RELEASE_CALENDAR_CRITICAL",
    label: "Evento critico da agenda",
    category: "project",
    description: "Avisa criacao de evento critico de release, QA ou entrega.",
    criticality: "critical",
    mandatory: true,
    defaultChannels: ["in_app", "brain"],
    audienceScopes: ["company", "project", "role", "user"],
    recipientRules: ["Criador do evento", "Responsavel", "Lider do projeto", "Brain"],
    preferenceRules: ["Nao pode ser desativado", "Empresa nao bloqueia", "Usuario nao bloqueia", "Brain recebe contexto"],
  },
  {
    id: "release-calendar-risk",
    eventType: "RELEASE_CALENDAR_RISK",
    label: "Release em risco",
    category: "project",
    description: "Avisa quando evento de agenda muda para em risco.",
    criticality: "high",
    mandatory: false,
    defaultChannels: ["in_app", "chat", "brain"],
    audienceScopes: ["company", "project", "role", "user"],
    recipientRules: ["Responsavel", "Criador", "Lider do projeto", "Brain"],
    preferenceRules: ["Pode suprimir canais nao criticos", "Brain recebe contexto operacional"],
  },
  {
    id: "release-calendar-blocked",
    eventType: "RELEASE_CALENDAR_BLOCKED",
    label: "Release bloqueada",
    category: "project",
    description: "Avisa quando evento de agenda muda para bloqueado.",
    criticality: "critical",
    mandatory: true,
    defaultChannels: ["in_app", "email", "chat", "brain"],
    audienceScopes: ["company", "project", "role", "user"],
    recipientRules: ["Responsavel", "Criador", "Lider do projeto", "Brain"],
    preferenceRules: ["Nao pode ser desativado", "Entrega critica ignora opt-out", "Brain recebe contexto"],
  },
  {
    id: "access-updated",
...
export const notificationImplementationBacklog: NotificationImplementationItem[] = [
  ...
  },
  {
    ...
    priority: "high",
    acceptanceCriteria: [
      "Brain enxerga eventos gerados, entregues e suprimidos.",
      "Brain consegue explicar por que alguem recebeu ou nao recebeu.",
      "Brain pode resumir notificacoes por empresa/projeto/perfil."],
  },
  {
