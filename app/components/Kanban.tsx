...
const columns: {
...
}[] = [
  {
    key: "pass",
    label: "Pass",
    bgClass: "bg-[--kanban-pass-bg]",
    borderClass: "border-[--kanban-pass-border]",
    accentClass: "bg-[--kanban-pass-accent]",
  },
  {
    key: "fail",
    label: "Fail",
    bgClass: "bg-[--kanban-fail-bg]",
    borderClass: "border-[--kanban-fail-border]",
    accentClass: "bg-[--kanban-fail-accent]",
  },
  {
    key: "blocked",
    label: "Blocked",
    bgClass: "bg-[--kanban-blocked-bg]",
    borderClass: "border-[--kanban-blocked-border]",
    accentClass: "bg-[--kanban-blocked-accent]",
  },
  {
    key: "notRun",
    label: "Not Run",
    bgClass: "bg-[--kanban-notrun-bg]",
    borderClass: "border-[--kanban-notrun-border]",
    accentClass: "bg-[--kanban-notrun-accent]",
  },
];
