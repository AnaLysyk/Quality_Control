...
async function createSupportUsers(adminToken) {
  ...
  if (failureCount > 0) {
    ...
    log(colors.white, '      node tools/functions/banco-de-dados/usuarios/criar-usuarios-suporte-auto.js <TOKEN_ADMIN>\n');
  }
}
...
if (!adminToken) {
  ...
  log(colors.white, '  ADMIN_TOKEN=sua_senha node tools/functions/banco-de-dados/usuarios/criar-usuarios-suporte-auto.js\n');
  process.exit(1);
}
