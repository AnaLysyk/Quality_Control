...
# Uso: .\support\functions\infraestrutura\desenvolvimento\dev-watch.ps1
# Opcional: .\support\functions\infraestrutura\desenvolvimento\dev-watch.ps1 -LogFile meu-log.txt
