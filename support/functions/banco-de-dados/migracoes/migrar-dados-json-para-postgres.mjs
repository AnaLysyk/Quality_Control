 ...
 *
 * Uso:
 *   DATABASE_URL="postgresql://..." node --experimental-vm-modules support/functions/banco-de-dados/migracoes/seed-pg.mjs
 *
 * Ou via npx:
 *   npx tsx support/functions/banco-de-dados/migracoes/seed-pg.mjs
 *
