/**
 * Rodar:
 * npx playwright test tests/ui/login/solicitar-acesso/gestao-solicitacoes/aprovacao/aprovar-solicitacao.manual.ui.spec.ts --project=chromium
 */
...
import type { PerfilSolicitacao } from "../../../../../../tools/functions/ui/login/solicitar-acesso/formulario/preencher-formulario-por-perfil";
