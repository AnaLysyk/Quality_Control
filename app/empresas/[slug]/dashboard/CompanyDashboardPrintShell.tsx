...
export default function CompanyDashboardPrintShell({ children }: { children: ReactNode }) {
  return (
    <div className="dashboard-pdf-root">
      ...
      <header className="hidden border-b border-slate-200 pb-4 print:mb-5 print:block">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-slate-500">RelatÃ³rio operacional</p>
        <h1 className="mt-1 text-2xl font-black text-slate-950">Dashboard da Empresa</h1>
        <p className="mt-1 text-sm text-slate-600">ExportaÃ§Ã£o do recorte filtrado.</p>
      </header>
