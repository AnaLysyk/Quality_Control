...
import { SYSTEM_MODULE_BY_ID } from "@/backend/navigation/module-map";
import { SYSTEM_ROUTES } from "@/backend/navigation/route-map";
import type { SystemModuleId, SystemPermission, SystemRouteDefinition } from "@/backend/navigation/navigation.types";
...
import { getUserAccessContext, type UserAccessContext } from "@/backend/permissions/get-user-access-context";
...
const MODULE_PERMISSION_REQUIREMENTS: Record<string, SystemPermission[]> = {
  ...
  execucoes: [{ moduleId: "test_run", action: "read" }, { moduleId: "runs", action: "view" }],
  "fila-de-execucao": [{ moduleId: "test_run", action: "read" }, { moduleId: "runs", action: "view" }],
  historico: [{ moduleId: "audit", action: "view" }],
  "fluxos-de-automacao": [{ moduleId: "playwright", action: "read" }],
  "controle-de-qualidade": [{ moduleId: "test_repository", action: "read" }],
