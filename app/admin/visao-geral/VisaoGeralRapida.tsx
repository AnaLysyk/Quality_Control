...
const selectedCardClass = "relative flex w-[78vw] min-w-56 max-w-72 shrink-0 flex-col gap-3 overflow-hidden rounded-3xl border border-[rgba(239,0,1,.28)] bg-[linear-gradient(180deg,var(--tc-surface)_0%,var(--tc-surface-2)_100%)] p-4 text-left shadow-[0_24px_44px_rgba(1,24,72,.12)] ring-1 ring-[rgba(239,0,1,.16)] transition";
const idleCardClass = "relative flex w-[78vw] min-w-56 max-w-72 shrink-0 flex-col gap-3 overflow-hidden rounded-3xl border border-[var(--tc-border)] bg-[var(--tc-surface)] p-4 text-left transition hover:border-[rgba(239,0,1,.18)] hover:shadow-[0_18px_35px_rgba(1,24,72,.08)]";
