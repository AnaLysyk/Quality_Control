...
import { hasForcedGlobalAccessForUser } from "@/backend/auth/specialAccess";
import { resolvePermissionRoleForUser } from "@/backend/adminUsers";
import { resolveCapabilities } from "@/backend/permissions";
...
export type AccessContext = {
  ...
  // backend/auth/accessAssignment.ts.
  companySlugs: string[];
