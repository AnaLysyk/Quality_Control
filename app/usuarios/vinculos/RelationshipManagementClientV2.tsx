...
export default function RelationshipManagementClientV2() {
    ...
    return (
      ...
      >
        {person ? mode === "leaders" ? (
          ...
          <div className="relationship-person-context">
            <section className="relationship-inline-section">
              <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">Empresas e acessos empresariais</p>
              {person.memberships?.length ? person.memberships.map((membership) => (
                <div key={membership.companyId} className="relationship-link-line">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs" style={{ color: "var(--rel-muted)" }}>{membership.allowedProjectIds?.length ? `${membership.allowedProjectIds.length} projetos selecionados` : "Todos os projetos da empresa"}</p>
                  </div>
                </div>
