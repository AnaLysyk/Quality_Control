 ...
 * âš ï¸  SEM cleanup — dados permanecem permanentemente no PostgreSQL.
 *
 * Perfis criados:
...
describePg("Seed — Testing Company + perfis de usuário", () => {
  ...
  it("cria ou reutiliza a empresa Testing Company", async () => {
    ...
    if (existing) {
      ...
      console.log(`\nâ™»ï¸  Empresa já existe: ${existing.name} | slug: ${existing.slug} | id: ${existing.id}`);
      return;
    }
  ...
  // â”€â”€ Usuário Empresa (viewer) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  it("cria Usuário Empresa vinculado como viewer", async () => {
    ...
    if (existing) {
      userId = existing.id;
      console.log(`\nâ™»ï¸  Usuário Empresa já existe | id: ${existing.id}`);
    } else {
      ...
      userId = user.id;
      console.log(`\nâœ… Usuário Empresa criado | email: ${email} | id: ${userId}`);
    }
  ...
  // â”€â”€ Usuário Testing Company (viewer) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  it("cria Usuário Testing Company vinculado como viewer", async () => {
    ...
    if (existing) {
      userId = existing.id;
      console.log(`\nâ™»ï¸  Usuário TC já existe | id: ${existing.id}`);
    } else {
      const user = await pgCreateLocalUser({
      ...
      userId = user.id;
      console.log(`\nâœ… Usuário TC criado | email: ${email} | id: ${userId}`);
    }
  ...
  // â”€â”€ Líder TC (company_admin) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  it("cria Líder TC vinculado como company_admin", async () => {
    ...
    if (existing) {
      userId = existing.id;
      console.log(`\nâ™»ï¸  Líder TC já existe | id: ${existing.id}`);
    } else {
      const user = await pgCreateLocalUser({
        name: "Líder TC",
        email,
      ...
      userId = user.id;
      console.log(`\nâœ… Líder TC criado | email: ${email} | id: ${userId}`);
    }
  ...
  // â”€â”€ Suporte Técnico (it_dev + global_admin) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  it("cria Suporte Técnico com role it_dev e global_admin", async () => {
    ...
    if (existing) {
      userId = existing.id;
      console.log(`\nâ™»ï¸  Suporte Técnico já existe | id: ${existing.id}`);
    } else {
      const user = await pgCreateLocalUser({
      ...
      userId = user.id;
      console.log(`\nâœ… Suporte Técnico criado | email: ${email} | role: it_dev | id: ${userId}`);
    }
  ...
  // â”€â”€ Verificação final â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
