...
describeDb("Vincular usuário a empresa e visibilidade", () => {
  // â”€â”€ Cenário 1: vincular como viewer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  test("1. Vincular usuário como viewer → membership retornada", async () => {
    ...
    console.log(`âœ… Cenário 1 | user=${user.email} vinculado como viewer | companyId=${company.id}`);
  });

  // â”€â”€ Cenário 2: vincular como company_admin â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  test("2. Vincular usuário como company_admin → role normalizado", async () => {
    ...
    console.log(`âœ… Cenário 2 | user=${user.email} vinculado como company_admin`);
  });

  // â”€â”€ Cenário 3: vincular como it_dev â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  test("3. Vincular usuário como it_dev → role it_dev confirmado", async () => {
    ...
    console.log(`âœ… Cenário 3 | user=${user.email} vinculado como it_dev`);
  });

  // â”€â”€ Cenário 4: resolveUserCompanies retorna empresa â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  test("4. resolveUserCompanies retorna empresa vinculada com dados completos", async () => {
    ...
    console.log(`âœ… Cenário 4 | resolveUserCompanies retornou empresa=${resolved[0].company?.slug}`);
  });

  // â”€â”€ Cenário 5: usuário sem vínculo não vê empresa â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  test("5. Usuário sem vínculo → resolveUserCompanies vazio (visibilidade zero)", async () => {
    ...
    console.log(`âœ… Cenário 5 | user=${user.email} sem vínculo → nenhuma empresa visível`);
  });

  // â”€â”€ Cenário 6: desvincular → links vazios, empresa some da visibilidade â”€â”€â”€â”€
  test("6. Desvincular usuário → links vazios, empresa some da visibilidade", async () => {
    ...
    console.log(`âœ… Cenário 6 | user=${user.email} desvinculado → 0 empresas visíveis`);
  });

  // â”€â”€ Cenário 7: listLocalLinksForCompany lista membros â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  test("7. listLocalLinksForCompany lista todos os membros da empresa", async () => {
    ...
    console.log(`âœ… Cenário 7 | empresa ${company.slug} tem ${testMembers.length} membros: viewer + company_admin`);
  });

  // â”€â”€ Cenário 8: dois usuários vinculados à mesma empresa â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  test("8. Dois usuários vinculados à mesma empresa → ambos visualizam a empresa", async () => {
    ...
    console.log(`âœ… Cenário 8 | empresa ${company.slug} visível para userA e userB`);
  });

  // â”€â”€ Cenário 9: atualizar role via upsert â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  test("9. Atualizar role via upsert (viewer → company_admin)", async () => {
    ...
    console.log(`âœ… Cenário 9 | role atualizado: viewer → company_admin (sem duplicar membership)`);
  });

  // â”€â”€ Cenário 10: vínculo com capabilities personalizadas â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  test("10. Vínculo com capabilities personalizadas → capabilities persistidas", async () => {
    ...
    console.log(`âœ… Cenário 10 | capabilities=${caps.join(",")} persistidas no vínculo`);
  });

  // â”€â”€ Cenário 11: usuário vinculado a múltiplas empresas â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  test("11. Usuário vinculado a múltiplas empresas → resolveUserCompanies retorna todas", async () => {
    ...
    console.log(`âœ… Cenário 11 | user vinculado a 3 empresas → resolveUserCompanies retornou ${resolved.length} (>= 3)`);
  });

  // â”€â”€ Cenário 12: remover vínculo de uma empresa, manter a outra â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  test("12. Remover vínculo de uma empresa mantém vínculo nas demais", async () => {
    ...
    console.log(`âœ… Cenário 12 | vínculo com companyA removido | companyB mantida na visibilidade`);
  });
});
