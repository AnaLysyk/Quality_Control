                ...
                <div className={sectionMuted + " flex flex-wrap items-center justify-between gap-4"}>
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    <span className="text-xs text-[#94a3b8]">
                      <span suppressHydrationWarning={true}>{new Date(selected.createdAt).toLocaleString("pt-BR")}</span>
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <label className="block text-sm font-medium text-[#1e293b]">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setDraft((d: Partial<AccessRequestItem> | null) => (d ? { ...d, clientId: id, company: match?.name ?? d.company ?? "" } : d));
                        try {
                  ...
                  <label className="block text-sm font-medium text-[#1e293b]">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        draftTouchedRef.current = true;
                        setDraft((d: Partial<AccessRequestItem> | null) => (d ? { ...d, name: e.target.value } : d));
                      }}
                    />
                  </label>
                  ...
                  <label className="block text-sm font-medium text-[#1e293b]">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        draftTouchedRef.current = true;
                        setDraft((d: Partial<AccessRequestItem> | null) => (d ? { ...d, email: e.target.value } : d));
                      }}
                    />
                  </label>
                  ...
                  <label className="block text-sm font-medium text-[#1e293b] sm:col-span-2">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        draftTouchedRef.current = true;
                        setDraft((d: Partial<AccessRequestItem> | null) => (d ? { ...d, jobRole: e.target.value } : d));
                      }}
                    />
                  </label>
                  ...
                  <label className="block text-sm font-medium text-[#1e293b] sm:col-span-2">
                    ...
                    <textarea
                      ...
                      onChange={(e) => {
                        draftTouchedRef.current = true;
                        setDraft((d: Partial<AccessRequestItem> | null) => (d ? { ...d, notes: e.target.value } : d));
                      }}
                    />
                  </label>
                  ...
                  <label className="block text-sm font-medium text-[#1e293b] sm:col-span-2">
                    ...
                    <textarea
                      ...
                      onChange={(e) => {
                        draftTouchedRef.current = true;
                        setDraft((d: Partial<AccessRequestItem> | null) => (d ? { ...d, adminNotes: e.target.value } : d));
                      }}
                    />
                  </label>
                </div>
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="comments-chat-meta">
                                <span suppressHydrationWarning={true}>{new Date(comment.createdAt).toLocaleString("pt-BR")}</span>
                              </div>
                            </div>
                          );
                        })
