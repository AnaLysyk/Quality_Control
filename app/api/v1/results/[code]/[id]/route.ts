...
import { resolveRunRole, getRunMockRole, canCreateRun } from "@/backend/rbac/runs";
...
export async function POST(request: Request, { params }: RouteParams) {
  ...
  try {
    const data = await client.createResult(projectCode, runId, body as Record<string, unknown>);
