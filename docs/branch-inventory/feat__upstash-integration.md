...
- head: `2179cbc`
- unique commits: 63
- compare: https://github.com/AnaLysyk/Quality_Control/compare/main...feat/upstash-integration

## Hotspots

- app/api: 103 arquivos
- data/companies: 73 arquivos
- app/components: 36 arquivos
- data/backups: 31 arquivos
- data/versions: 20 arquivos
- app/admin: 19 arquivos
- scripts: 19 arquivos
- src: 16 arquivos
...
- data/user-notifications.json (21612 linhas alteradas)
- app/globals.css (6802 linhas alteradas)
...
- `2179cbc` 2026-03-14 project-bot: fix: align support auth and force webpack dev
- `0fcb3a4` 2026-03-13 project-bot: fix(ts): corrige erros de tipo que quebravam o build no Render
- `dcf7263` 2026-03-13 project-bot: feat: ajustes UI ChatButton e correções gerais
- `b8d6fee` 2026-03-08 project-bot: chore: sync all local workspace changes
- `63fffcc` 2026-03-08 project-bot: feat: refine admin user management layouts
- `f6379cd` 2026-03-07 project-bot: Atualiza: subir alterações
- `2cce693` 2026-03-06 project-bot: Add webpack alias for @/lib to fix resolver
- `a96aafc` 2026-03-06 project-bot: Enforce consistent casing in tsconfig
- `f586c94` 2026-03-06 project-bot: Normalize jwtAuth casing and imports
- `53195d7` 2026-03-06 project-bot: fix(api): remove duplicate GET/POST in notes route (use userNotesStore)
- `b72e249` 2026-03-06 project-bot: chore(menu): add 'Gestão' entry linking to permissions page (admin only)
- `895d46b` 2026-03-06 project-bot: fix(a11y): add accessible name to role select in users create form
