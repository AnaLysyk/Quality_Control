/**
 * Rodar:
 * npx playwright test tests/ui/login/solicitar-acesso/consulta/consultar-status.ui.spec.ts --project=chromium
 */
...
import { criarEmailTeste, limparEmailsCapturados } from "../../../../../tools/functions/api/solicitar-acesso/emails/capturar-emails";
import {
...
import { autenticarSolicitacaoAcessoViaApi } from "../../../../../tools/functions/api/solicitar-acesso/autenticacao/autenticar-revisor";
import { abrirStatusPorLink } from "../../../../../tools/functions/ui/login/solicitar-acesso/consulta/abrir-consulta-status";
