...
import { FiAlertTriangle, FiBox, FiCheckCircle, FiCpu, FiFileText, FiGitBranch, FiUser, FiZap } from "react-icons/fi";
...
function BrainNeuronNodeComponent({ data, selected }: NodeProps) {
  ...
  return (
    ...
    >
      ...
      <span className="relative z-10 max-w-[78%] text-[12px] font-black leading-tight">
        {node.label}
      </span>

      <span className="relative z-10 mt-1 max-w-[78%] truncate text-[8px] font-black uppercase tracking-[0.15em] opacity-60">
        {isCore ? labelize(node.type) : node.module}
      </span>
