...
function BrainConsole({ userName, profile, greeting, authUser }: { userName: string; profile: ProfileExperience; greeting: string; authUser: unknown }) {
  ...
  async function askHomeBrain(text: string) {
    ...
    setCommand("");
    setSendingHome(true);
    setUpdates((current) => [...current.filter((turn) => turn.id !== "brain-thinking-home"), { id: "brain-thinking-home", title: "Brian está analisando", text: `Estou varrendo a ${scope}, cruzando contexto e preparando o espaço de informação.`, scope, ts: Date.now() }].slice(-8));
  ...
  return (
    <section className="brain-home-shell relative flex min-h-[calc(100vh-4.75rem)] w-full max-w-none overflow-hidden rounded-none bg-[var(--brain-bg)] px-4 py-4 text-[var(--brain-text)] sm:rounded-[1.8rem] lg:min-h-[calc(100vh-5.5rem)] lg:px-8 lg:py-6">
      <style>{`
        .brain-home-shell{--brain-bg:radial-gradient(circle at 12% 12%,rgba(239,0,1,.045),transparent 25%),radial-gradient(circle at 86% 18%,rgba(59,130,246,.08),transparent 28%),linear-gradient(135deg,#fff 0%,#f8fbff 52%,#eef5ff 100%);--brain-text:#061225;--brain-muted:rgba(6,18,37,.62);--brain-panel:rgba(255,255,255,.72);--brain-panel-strong:rgba(255,255,255,.9);--brain-border:rgba(15,23,42,.12);--brain-chip:rgba(1,24,72,.055);--brain-input:rgba(255,255,255,.88);--brain-shadow:rgba(15,23,42,.10)}
        ...
        .brain-orb-zone{min-height:clamp(360px,62vh,680px);display:grid;place-items:center}.brain-orb-wrap{position:relative;width:clamp(310px,35vw,560px);height:clamp(310px,35vw,560px);display:grid;place-items:center;isolation:isolate;perspective:900px;animation:brainRobotHover 6.4s ease-in-out infinite}.brain-orbit{position:absolute;inset:13%;z-index:1;border-radius:999px;transform-style:preserve-3d;filter:drop-shadow(0 0 18px rgba(255,42,68,.30));animation:brainOrbit 11s linear infinite}.brain-orbit:before{content:"";position:absolute;inset:0;border-radius:inherit;padding:1.6px;background:conic-gradient(from 120deg,transparent 0deg,transparent 42deg,rgba(255,42,68,.95) 70deg,rgba(255,42,68,.18) 104deg,transparent 145deg,rgba(167,205,255,.34) 220deg,transparent 292deg,rgba(255,42,68,.72) 330deg,transparent 360deg);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask-composite:exclude}.orbit-one{inset:20%;transform:rotateX(68deg) rotateZ(-18deg);animation-duration:8s}.orbit-two{inset:10%;opacity:.62;transform:rotateX(74deg) rotateY(28deg) rotateZ(20deg);animation-duration:14s;animation-direction:reverse}.orbit-three{inset:0;opacity:.33;transform:rotateX(58deg) rotateY(-38deg) rotateZ(8deg);animation-duration:23s}.brain-satellite{position:absolute;z-index:3;width:7px;height:7px;border-radius:999px;background:#ff2a44;box-shadow:0 0 16px rgba(255,42,68,.95),0 0 36px rgba(255,42,68,.36);animation:brainSatellite 7s ease-in-out infinite}.sat-one{left:18%;top:33%}.sat-two{right:17%;top:42%;width:5px;height:5px;animation-delay:-2.1s;background:#dbeafe;box-shadow:0 0 18px rgba(219,234,254,.9)}.sat-three{left:48%;bottom:13%;width:4px;height:4px;animation-delay:-3.4s}.brain-orb-aura{position:absolute;z-index:0;width:58%;height:58%;border-radius:999px;background:radial-gradient(circle,rgba(255,42,68,.22),transparent 62%);filter:blur(26px);opacity:.58;animation:brainAura 5.4s ease-in-out infinite}.brain-orb{position:relative;z-index:4;width:44%;height:44%;border-radius:999px;overflow:hidden;background:radial-gradient(circle at 62% 18%,rgba(220,235,255,.14),transparent 22%),radial-gradient(circle at 45% 42%,#101826 0%,#050913 55%,#000 100%);border:1px solid rgba(255,255,255,.13);box-shadow:inset 14px 14px 32px rgba(255,255,255,.055),inset -30px -34px 58px rgba(0,0,0,.92),0 0 26px rgba(255,42,68,.28),0 0 78px rgba(255,42,68,.15),0 0 120px rgba(147,197,253,.12);animation:brainBotBreath 4.8s ease-in-out infinite;transform:rotateX(var(--brain-tilt-x,0deg)) rotateY(var(--brain-tilt-y,0deg));transition:transform .16s ease-out}.brain-orb-depth{position:absolute;inset:0;border-radius:inherit;background:radial-gradient(circle at 36% 62%,rgba(255,42,68,.18),transparent 36%),radial-gradient(circle at 70% 22%,rgba(150,196,255,.18),transparent 26%)}.brain-orb-glow{position:absolute;left:-8%;bottom:7%;width:42%;height:48%;border-radius:999px;border-left:4px solid rgba(255,42,68,.96);border-bottom:3px solid rgba(255,42,68,.50);filter:drop-shadow(0 0 12px rgba(255,42,68,.82));transform:rotate(-28deg)}.brain-orb-glass{position:absolute;inset:0;border-radius:inherit;background:radial-gradient(circle at 34% 34%,rgba(255,255,255,.18),transparent 9%),radial-gradient(circle at 67% 23%,rgba(230,242,255,.16),transparent 17%),linear-gradient(145deg,rgba(255,255,255,.05),transparent 45%)}
        ...
        .brain-info-space{height:min(62vh,620px);min-height:430px;border:1px solid var(--brain-border);border-radius:2rem;background:var(--brain-panel);box-shadow:0 26px 80px var(--brain-shadow);-webkit-backdrop-filter:blur(18px);backdrop-filter:blur(18px)}.brain-update-scroll{scrollbar-width:thin;scrollbar-color:rgba(239,0,1,.45) transparent}.brain-update-scroll::-webkit-scrollbar{width:7px}.brain-update-scroll::-webkit-scrollbar-thumb{border-radius:999px;background:rgba(239,0,1,.45)}
      ...
      <div className="relative z-10 grid w-full flex-1 items-center gap-6 pt-16 lg:grid-cols-[minmax(320px,43vw)_minmax(0,1fr)] lg:pt-14 xl:grid-cols-[minmax(420px,46vw)_minmax(0,1fr)]">
