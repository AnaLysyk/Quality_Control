import { listApplications, syncCompanyApplications } from "@/backend/applicationsStore";
import { findLocalCompanyBySlug } from "@/backend/auth/localStore";
import { mapCompanyRecord } from "@/backend/companyRecord";
import { getCompanyDefects, type IntegratedProjectAccessStatus } from "@/backend/companyDefects";
import { summarizeDefectActivity } from "@/backend/defectActivity";
import { listDefectHistories } from "@/backend/manualDefectHistoryStore";
import { listManualReleaseResponsibleOptions, type ManualReleaseResponsibleOption } from "@/backend/manualReleaseResponsible";
