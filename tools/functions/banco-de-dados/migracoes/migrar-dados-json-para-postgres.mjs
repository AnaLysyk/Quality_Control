 ...
 *
 * Uso:
 *   DATABASE_URL="postgresql://..." node --experimental-vm-modules tools/functions/banco-de-dados/migracoes/seed-pg.mjs
 *
 * Ou via npx:
 *   npx tsx tools/functions/banco-de-dados/migracoes/seed-pg.mjs
 *
