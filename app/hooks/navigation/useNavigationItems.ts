...
const PERMISSION_MANAGEMENT_ROLES: SystemRole[] = MANAGEMENT_ROLES;
const TC_USER_CREATOR_ROLES: SystemRole[] = MANAGEMENT_ROLES;
const COMPANY_USER_CREATOR_ROLES: SystemRole[] = MANAGEMENT_ROLES;
