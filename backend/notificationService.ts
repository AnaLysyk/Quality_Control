...
import type { TicketCommentRecord } from "@/backend/ticketCommentsStore";
import type { CompanyDefectRecord } from "@/backend/companyDefects";
import {
  closeNotificationsByDedupeKey,
  createNotificationsForUsers,
} from "@/backend/userNotificationsStore";
import {
  listLocalCompanies,
