...
export const NAV_CATALOG: NavModuleDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ops-apps",      label: "Aplicações",      iconKey: "grid",         module: "operations", companyRoute: "aplicacoes",                                  favoriteEnabled: true },
      { id: "ops-plans",     label: "Planos de teste", iconKey: "book",         module: "operations", companyRoute: "planos-de-teste",                             favoriteEnabled: true },
