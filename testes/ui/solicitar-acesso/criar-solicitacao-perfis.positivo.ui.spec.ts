...
import { capturarChaveDoEmailSolicitacao } from "../../../support/functions/api/solicitar-acesso/extrair-chave-email";
import {
  abrirFormularioSolicitacaoPorPerfil,
  perfisSolicitacao,
  preencherFormularioSolicitacaoPorPerfil,
  prepararMocksPublicosSolicitacao,
} from "../../../support/functions/interface/solicitar-acesso/preencher-formulario-por-perfil";
