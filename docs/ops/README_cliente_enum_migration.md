...
1. Disponibilize e execute `support/functions/banco-de-dados/migracoes/cliente/17_fix_cliente_enums.sql` no ambiente de staging.
   ...
   - Para tabelas muito grandes, rode `support/functions/banco-de-dados/migracoes/cliente/17_fix_cliente_enums_batch.sql` antes do swap.
